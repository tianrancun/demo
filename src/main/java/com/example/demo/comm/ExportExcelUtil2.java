...
public class ExportExcelUtil2<T>{
     ...
     */
    public void exportExcel(String title, List<T> dataset, OutputStream out, String version) {
...
//            exportExcel2003(title, null, dataset, out, "yyyy-MM-dd HH:mm:ss");
     ...
     * @param version 2003 或者 2007，不传时默认生成2003版本
     */
    public void exportExcel(String title,String[] headers, List<T> dataset, OutputStream out,String version) {
...
//            exportExcel2003(title, headers, dataset, out, "yyyy-MM-dd HH:mm:ss");
    ...
    public void exportExcel2007(String title, String[] headers, List<T> dataset, OutputStream out, String pattern) {
        // 声明一个工作薄
